//
//  NotchMediaXPCHelperProtocol.swift
//  NotchMediaXPCHelper
//
...
@objc protocol NotchMediaXPCHelperProtocol {
...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     connectionToService = NSXPCConnection(serviceName: "media.notch.NotchMedia.NotchMediaXPCHelper")
     connectionToService.remoteObjectInterface = NSXPCInterface(with: (any NotchMediaXPCHelperProtocol).self)
     connectionToService.resume()

 Once you have a connection to the service, you can use it like this:

     if let proxy = connectionToService.remoteObjectProxy as? NotchMediaXPCHelperProtocol {
