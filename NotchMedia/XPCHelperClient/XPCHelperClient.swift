...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "media.notch.NotchMedia.NotchMediaXPCHelper"
    
    private var remoteService: RemoteXPCService<NotchMediaXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<NotchMediaXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<NotchMediaXPCHelperProtocol>(
            connection: conn,
            remoteInterface: NotchMediaXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<NotchMediaXPCHelperProtocol>? {
        remoteService
    }
